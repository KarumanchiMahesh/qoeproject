...
<body>
    ...
    $sql3 = "update temporary_data set vid5="."'".$vid5."'"." where subject_id=".$id;
    ...
    <div class="container">
        <br>
            <div class="col-md-4">
                <font color="white" class="h1">Test Video 3</font>
            </div>
            ...
            $('#next').on('click', function() {
                if ($(this).attr('visibility') === 'hidden') {
                    // do nothing
                            ...
                            window.location.href = "form7.php?id=<?php echo $id ?>";
                        }
                    });
