...
<body>
    ...
    $res = $conn->query("update temporary_data set vid3="."'".$vid."'"." where subject_id=".$id);
    $res = $conn->query("update tasks_completed set pagepos="."'"."vid3"."'"." where subject_id=".$id);
    ...
    <script type="text/javascript">
            ...
            $(window).load(function() {
                $("#Video1").bind('ended', function() {
                    window.location.href = "rating3.php?id=<?php echo $id;?>";
                });
            });
